...
var dialog = [
	"Uf nunca hay nada en esta casa.",
]
var dialog2 = [
	"Miguel",
]
var dialog3 = [
	"Sanguches de anoche, espero que le gusten.",
	"Igual ni que hubiese mucho más acá, tenemos que ir urgente al super.",
]
var dialog4 = [
	"Miguel",
	"Miguel",
